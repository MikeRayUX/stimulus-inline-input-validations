...
//     // Length START
//     cy.get(`input[data-validate-length="5,10"][data-field='userName']`).click();
//     cy.wait(FOCUS_FIELD_DELAY_MS);
...
//     cy.get(`input[data-validate-length="5,10"][data-field='userName']`).clear();
...
//     // Numericality START
//     cy.get(`input[data-validate-numericality="true"][data-field='currency']`).click();
//     cy.wait(FOCUS_FIELD_DELAY_MS);

//     cy.get(
//       `input[data-validate-numericality="true"][data-field='currency']`
...
//     // Email START
//     cy.get(`input[data-validate-email="true"][data-field='emailField']`).click();
//     cy.wait(FOCUS_FIELD_DELAY_MS);

//     cy.get(
//       `input[data-validate-email="true"][data-field='emailField']`
